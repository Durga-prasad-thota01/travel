...
const mocks = [
  {
    ...
    temperature: 30,
    title: 'Hyberabad',
    description: 'Hyderabad is the capital of the Indian state of Telangana. It is a historic city noted for its many monuments, temples, mosques and bazaars. A multitude of influences has shaped the character of the city in the last 400 years',
    rating:3.3,
    reviews: 2512,
  ...
  },
  {
    ...
    temperature: 34,
    title: 'Bengaluru',
    description: 'Bengaluru, also spelled Bengalooru, formerly Bangalore, city, capital (since 1830) of Karnataka state, southern India. Bengaluru is one of India’s largest cities. It lies 3,113 feet (949 metres) above sea level, atop an east-west ridge in the Karnataka Plateau in the southeastern part of the state, at a cultural meeting point of the Kannada-, Telugu-, and Tamil-speaking peoples.',
    rating: 4.6,
    reviews: 3212,
  ...
  },
  {
    ...
    temperature: 34,
    title: 'Bhimavaram',
    description: 'Bhimavaram is in the epicentre of the Godavari delta region. It is one of the principal trade centres of paddy in the state of Andhra Pradesh',
    rating: 3.2,
    reviews: 3212,
    preview: 'https://images.unsplash.com/photo-1507501336603-6e31db2be093?auto=format&fit=crop&w=800&q=80',
    images: [
  ...
  },
  {
    ...
    temperature: 34,
    title: 'Chennai',
    description: 'Chennai, originally known as "Madras", was located in the province of Tondaimandalam, an area lying between Penna River of Nellore and the Ponnaiyar river of Cuddalore. The capital of the province was Kancheepuram.',
    rating: 3.5,
    reviews: 562,
    preview: 'https://images.unsplash.com/photo-1458906931852-47d88574a008?auto=format&fit=crop&w=800&q=80',
    images: [
